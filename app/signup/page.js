...
export default function SignupPage() {
  ...
  const stats = [
    { value: '1,200+', label: 'Members', icon: '⛳' },
    { value: '£48K+', label: 'To Charity', icon: '💚' },
    { value: 'Monthly', label: 'Prize Draws', icon: '🏆' },
  ]
    ...
    <>
      <style>{`
        ...
        .bg-mesh {
          ...
          inset: 0;
          background:
            radial-gradient(ellipse 70% 60% at 20% 30%, rgba(34,197,94,0.12) 0%, transparent 60%),
            radial-gradient(ellipse 50% 50% at 80% 70%, rgba(21,128,61,0.09) 0%, transparent 55%),
        ...
        .auth-container {
          ...
          padding-top: 3rem; /* spacing below navbar */
        }        
        ...
        .stat-icon { font-size: 1.1rem; margin-bottom: 0.35rem; }
        .stat-value {
        ...
        .field-wrap.is-focused .field-icon { color: #22c55e; }
        ...
        <div className="auth-container">
          ...
          <div className="auth-card">
            ...
            <div className="perks-row">
              {['Free to join', 'Cancel anytime', 'Charity impact'].map(perk => (
